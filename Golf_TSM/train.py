...
if __name__ == '__main__':
    ...
    model = MobileNetV2(n_class=9)
    model.train()
    model.cuda()

    state_dict_mobilenet = torch.load('mobilenet_v2.pth.tar')
    del state_dict_mobilenet["classifier.1.bias"], state_dict_mobilenet["classifier.1.weight"] 
    model.load_state_dict(state_dict_mobilenet, strict = False)
    ...
    while i < iterations:
        for sample in data_loader:
            ...
            writer.add_scalar("AverageMeterLoss/iter", loss, i)
